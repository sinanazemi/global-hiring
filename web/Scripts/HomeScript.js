var app = angular.module("myApp", ['ngRoute', 'ngResource', 'ui.bootstrap','ngAnimate', 'ngFileUpload', 'ngImgCrop', 'selectize']);
/*var app = angular.module("myApp", ['ngRoute','ngAnimate', 'ui.bootstrap', 'selectize', 'ngResource', 'ngFileUpload', 'ngImgCrop']);*/
    ...
    function ($scope, $window, $resource, $document) {
        ...
        $scope.toggleSelectedSRV = function (service) {
            ...
            if (!service.isselected) {
                for(var i=0;i<service.skills.length;i++)
                {
                    service.skills[i].isselected = false;
                }
            }
        };
                  ...
                  for(var i=0;i<$scope.account.skills.length;i++)
                  {
                      for(var j=0;j<$scope.mainServices.length;j++)
                      {
                          if ($scope.account.skills[i].mainserviceid == $scope.mainServices[j].id) {
                              ...
                              {
                                  if ($scope.mainServices[j].skills[z].id == $scope.account.skills[i].skillid) {
        ...
        /*****************************/
        var saveSkillRes = $resource("/updateSkills")
        $scope.saveSkill = function () {
            var saveSk = new saveSkillRes();
            saveSk.selectedmainservices = $scope.mainServices;
            saveSk.$save(
              function (data) {
                  $scope.account = data;
                  $('#addSkill').modal('hide');
        ...
        // -------- for hide panel in admin view
        $scope.whHidePanelClick = function(){
            $scope.whHidePanel = !$scope.whHidePanel;
            if($scope.whHidePanel)
                $scope.whPanelStyle = {'border-color': 'red' };
            else
                $scope.whPanelStyle = {'border-color' : '#ddd'};
        ...
        // -------- for hide panel in admin view
        $scope.eduHidePanelClick = function(){
            $scope.eduHidePanel = !$scope.eduHidePanel;
            if($scope.eduHidePanel)
                $scope.eduPanelStyle = {'border-color': 'red' };
            else
                $scope.eduPanelStyle = {'border-color' : '#ddd'};
        ...
        function SavePrj() {
            if (checkPrjValidation()) {
                ...
                savePrj.id = ($scope.prjId==""?-1:$scope.prjId);
        ...
        // -------- for hide panel in admin view
        $scope.prjHidePanelClick = function(){
            $scope.prjHidePanel = !$scope.prjHidePanel;
            if($scope.prjHidePanel)
                $scope.prjPanelStyle = {'border-color': 'red' };
            else
                $scope.prjPanelStyle = {'border-color' : '#ddd'};
        }
        ...
        // -------- for hide panel in admin view
        $scope.volHidePanelClick = function(){
            $scope.volHidePanel = !$scope.volHidePanel;
            if($scope.volHidePanel)
                $scope.volPanelStyle = {'border-color': 'red' };
            else
                $scope.volPanelStyle = {'border-color' : '#ddd'};
        }
        ...
        // -------- for hide panel in admin view
        $scope.crfHidePanelClick = function(){
            $scope.crfHidePanel = !$scope.crfHidePanel;
            if($scope.crfHidePanel)
                $scope.crfPanelStyle = {'border-color': 'red' };
            else
                $scope.crfPanelStyle = {'border-color' : '#ddd'};
        }
        ...
        // -------- for hide panel in admin view
        $scope.tcHidePanelClick = function(){
            $scope.tcHidePanel = !$scope.tcHidePanel;
            if($scope.tcHidePanel)
                $scope.tcPanelStyle = {'border-color': 'red' };
            else
                $scope.tcPanelStyle = {'border-color' : '#ddd'};
        }
        ...
        // -------- for hide panel in admin view
        $scope.haHidePanelClick = function(){
            $scope.haHidePanel = !$scope.haHidePanel;
            if($scope.haHidePanel)
                $scope.haPanelStyle = {'border-color': 'red' };
            else
                $scope.haPanelStyle = {'border-color' : '#ddd'};
        }
        ...
        // -------- for hide panel in admin view
        $scope.crHidePanelClick = function(){
            $scope.crHidePanel = !$scope.crHidePanel;
            if($scope.crHidePanel)
                $scope.crPanelStyle = {'border-color': 'red' };
            else
                $scope.crPanelStyle = {'border-color' : '#ddd'};
        }
